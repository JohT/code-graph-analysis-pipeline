...
NEO4J_APOC_PLUGIN_VERSION=${NEO4J_APOC_PLUGIN_VERSION:-"5.17.1"} # Version number matches Neo4j version since 5.x
...
NEO4J_GDS_PLUGIN_VERSION=${NEO4J_GDS_PLUGIN_VERSION:-"2.6.5"}  # Version 2.4.0 is the newest version of june 2023 and compatible with Neo4j v5
...
JQASSISTANT_CLI_VERSION=${JQASSISTANT_CLI_VERSION:-"2.2.1"}  # Version 2.0.3 is the newest version (june 2023) compatible with Neo4j v5
