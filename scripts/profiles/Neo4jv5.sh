...
NEO4J_VERSION=${NEO4J_VERSION:-"5.20.0"} # Version 5.9.0 is the current version of june 2023
...
NEO4J_APOC_PLUGIN_VERSION=${NEO4J_APOC_PLUGIN_VERSION:-"5.20.0"} # Version number matches Neo4j version since 5.x
...
NEO4J_GDS_PLUGIN_VERSION=${NEO4J_GDS_PLUGIN_VERSION:-"2.7.0"}  # Version 2.4.0 is the newest version of june 2023 and compatible with Neo4j v5
NEO4J_OPEN_GDS_PLUGIN_VERSION=${NEO4J_OPEN_GDS_PLUGIN_VERSION:-"2.7.0"} # Open package variant of the graph-data-science plugin for Neo4j (https://github.com/JohT/open-graph-data-science-packaging). Since version 2.4. compatible with Neo4j 5.x.
...
JQASSISTANT_CLI_VERSION=${JQASSISTANT_CLI_VERSION:-"2.3.0-M3"}  # Version 2.0.3 is the newest version (june 2023) compatible with Neo4j v5
