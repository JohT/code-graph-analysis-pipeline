...
NEO4J_VERSION=${NEO4J_VERSION:-"5.26.1"} # Version 5.9.0 is the current version of june 2023
...
NEO4J_APOC_PLUGIN_VERSION=${NEO4J_APOC_PLUGIN_VERSION:-"5.26.1"} # Version number matches Neo4j version since 5.x
...
JQASSISTANT_CLI_VERSION=${JQASSISTANT_CLI_VERSION:-"2.6.0-M3"} # Version number of the jQAssistant command line interface. Version 1.12.2 is compatible with Neo4j v4
