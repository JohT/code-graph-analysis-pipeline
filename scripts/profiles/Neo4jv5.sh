...
NEO4J_APOC_PLUGIN_VERSION=${NEO4J_APOC_PLUGIN_VERSION:-"5.14.0"} # Version number matches Neo4j version since 5.x
...
NEO4J_GDS_PLUGIN_VERSION=${NEO4J_GDS_PLUGIN_VERSION:-"2.5.4"}  # Version 2.4.0 is the newest version of june 2023 and compatible with Neo4j v5
NEO4J_OPEN_GDS_PLUGIN_VERSION=${NEO4J_OPEN_GDS_PLUGIN_VERSION:-"2.5.5+44"} # Graph Data Science Plugin Version 2.4.x of is compatible with Neo4j 5.x
...
JQASSISTANT_CLI_VERSION=${JQASSISTANT_CLI_VERSION:-"2.0.9"}  # Version 2.0.3 is the newest version (june 2023) compatible with Neo4j v5
