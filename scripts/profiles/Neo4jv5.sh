...
NEO4J_GDS_PLUGIN_VERSION=${NEO4J_GDS_PLUGIN_VERSION:-"2.4.6"}  # Version 2.4.0 is the newest version of june 2023 and compatible with Neo4j v5
...
JQASSISTANT_CLI_VERSION=${JQASSISTANT_CLI_VERSION:-"2.0.7"}  # Version 2.0.3 is the newest version (june 2023) compatible with Neo4j v5
