...
JQASSISTANT_CLI_VERSION=${JQASSISTANT_CLI_VERSION:-"2.10.0-M4"} # Version number of the jQAssistant command line interface. Version 1.12.2 is compatible with Neo4j v4
