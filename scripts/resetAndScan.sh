...
JQASSISTANT_CLI_VERSION=${JQASSISTANT_CLI_VERSION:-"2.2.1"} # 2.0.3 is the newest version (june 2023) compatible with Neo4j v5,  Version 1.12.2 is compatible with Neo4j v4
