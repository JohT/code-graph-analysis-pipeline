...
NEO4J_APOC_PLUGIN_VERSION=${NEO4J_APOC_PLUGIN_VERSION:-"5.17.1"} #Awesome Procedures for Neo4j Plugin, Version needs to be compatible to Neo4j
...
NEO4J_GDS_PLUGIN_VERSION=${NEO4J_GDS_PLUGIN_VERSION:-"2.6.0"} # Graph Data Science Plugin Version 2.4.x of is compatible with Neo4j 5.x
NEO4J_OPEN_GDS_PLUGIN_VERSION=${NEO4J_OPEN_GDS_PLUGIN_VERSION:-"2.6.1-23bc767797"} # Graph Data Science Plugin Version 2.4.x of is compatible with Neo4j 5.x
