...
5. `StronglyConnectedComponents_overview.cypher` — reads `communityStronglyConnectedComponentId`, groups + counts
6. `WeaklyConnectedComponents_overview.cypher` — reads `communityWeaklyConnectedComponentId`, groups + counts
7. `LocalClusteringCoefficient_nodes_by_coefficient.cypher` — reads `communityLocalClusteringCoefficient`, top 20 by value
