// Connect git log CSV files that were changed together frequently with "CHANGED_TOGETHER_WITH". Requires "Set_number_of_git_log_file_update_commits.cypher".
