// Create nodes for weakly connected components and connect them to their members. Requires "ArchetypeFeature-StronglyConnectedComponents-CreateNode.cypher".
