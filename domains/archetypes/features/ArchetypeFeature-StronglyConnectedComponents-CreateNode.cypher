// Create nodes for strongly connected components and connect them to their members. Requires "ArchetypeFeature-StronglyConnectedComponents-Write.cypher".
...
//    - name: derived from the highest PageRank member
   MERGE (component:StronglyConnectedComponent {id: componentId, memberType: $projection_node_label})
    WITH *
        ,CASE WHEN componentSize = 1 THEN 'Component ' ELSE 'Cycle around ' END AS componentNamePrefix
