// Topological Sort to write the property "topologicalSortMaxDistanceFromSource" (e.g. build order) for strongly connected components into the graph. Requires "ArchetypeFeature-TopologicalSortComponents-Projection".
