// Creates a projection of the strongly connected components graph for the given member type. Requires: "ArchetypeFeature-StronglyConnectedComponents-CreateDependency.cypher"
