...
def get_graph_database_driver() -> Driver:
    ...
    print("anomalyDetectionPlots: Successfully connected to Neo4j")
    return driver
...
def query_cypher_to_data_frame(query: typing.LiteralString, parameters: typing.Optional[typing.Dict[str, typing.Any]] = None):
    ...
    print(f"anomalyDetectionPlots: Successfully queried data from Neo4j after {summary.result_available_after} ms")
...
if (overall_cluster_count < 20):
    print(f"anomalyDetectionPlots: Less than 20 clusters: {overall_cluster_count}. Only one plot containing all clusters will be created.")
    plot_clusters(
    ...
    print(f"anomalyDetectionPlots: More than 20 clusters: {overall_cluster_count}. Different plots focussing on different features like cluster size will be created.")
