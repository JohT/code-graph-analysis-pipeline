...
# Results are written to reports/graph-algorithms/<NodeType>/similarity/ (e.g., Java_Package/similarity/).
...
FULL_REPORT_DIRECTORY="${REPORTS_DIRECTORY}/${REPORT_PARENT}/Java_Artifact/similarity"
...
FULL_REPORT_DIRECTORY="${REPORTS_DIRECTORY}/${REPORT_PARENT}/Java_Package/similarity"
mkdir -p "${FULL_REPORT_DIRECTORY}"
...
FULL_REPORT_DIRECTORY="${REPORTS_DIRECTORY}/${REPORT_PARENT}/Java_Type/similarity"
mkdir -p "${FULL_REPORT_DIRECTORY}"
...
FULL_REPORT_DIRECTORY="${REPORTS_DIRECTORY}/${REPORT_PARENT}/Typescript_Module/similarity"
mkdir -p "${FULL_REPORT_DIRECTORY}"
