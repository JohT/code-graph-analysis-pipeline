...
# Results are written to reports/community-csv/.
...
usage() {
    echo "Usage: $0 [--help]" >&2
    echo "" >&2
    echo "Detects communities (Louvain, Leiden, SCC, WCC, Label Propagation, K-Core," >&2
    echo "Approximate Maximum k-cut, LCC, HDBSCAN) via Neo4j GDS and writes results to CSV files." >&2
    echo "" >&2
