...
assemble_graph_algorithms_report() {
...

    {
        ...
        csv_link "Java_Package/communities/Package_Communities_Leiden.csv"
    } > "${report_include_directory}/LeidenCommunityOverview.md"

    {
        cypher_table "${STATISTICS_CYPHER_DIR}/StronglyConnectedComponents_overview.cypher"
        csv_link "Java_Package/communities/Package_Communities_Strongly_Connected_Components.csv"
    } > "${report_include_directory}/StronglyConnectedComponentsOverview.md"

    {
        cypher_table "${STATISTICS_CYPHER_DIR}/WeaklyConnectedComponents_overview.cypher"
        csv_link "Java_Package/communities/Package_Communities_Weakly_Connected_Components.csv"
    } > "${report_include_directory}/WeaklyConnectedComponentsOverview.md"

    {
        cypher_table "${STATISTICS_CYPHER_DIR}/LocalClusteringCoefficient_nodes_by_coefficient.cypher"
        csv_link "Java_Package/communities/Package_Communities_Local_Clustering_Coefficient_Aggregated.csv"
    } > "${report_include_directory}/LocalClusteringCoefficientNodesByCoefficient.md"

    # ── Similarity ─────────────────────────────────────────────────────────

    {
        cypher_table "${STATISTICS_CYPHER_DIR}/Jaccard_similarity_top_pairs.cypher"
        csv_link "Java_Package/similarity/Package_Similarity.csv"
